...
<body class="bg-gray-100 font-sans">
    ...
    <section class="hero-section">
        <div class="container mx-auto px-4 text-center">
            ...
            <a href="/reviews" class="cta-button">Beri Ulasan <i class="fas fa-chevron-right ml-2"></i></a>
        </div>
    </section>
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="feature-card">
                    <div class="text-red-600 mb-4 text-3xl"><i class="fas fa-utensils"></i></div>
                ...
                <div class="feature-card">
                    <div class="text-red-600 mb-4 text-3xl"><i class="fas fa-smile"></i></div>
                ...
                <div class="feature-card">
                    <div class="text-red-600 mb-4 text-3xl"><i class="fas fa-home"></i></div>
    ...
    <section class="bg-red-600 text-white py-12">
        <div class="container mx-auto px-6 text-center">
            ...
            <a href="/reviews" class="cta-button bg-white text-red-600">Tulis Ulasan Sekarang <i
